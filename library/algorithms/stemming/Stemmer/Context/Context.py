...
class Context(object):
    ...
    def init_visitors(self):
        ...
        self.prefix_penanda_visitors = self.visitor_provider.get_prefix_penanda_visitors()
        self.prefix_persona_visitors = self.visitor_provider.get_prefix_persona_visitors()
        self.prefix_pemanis_visitors = self.visitor_provider.get_prefix_pemanis_visitors()
    ...
    def remove_prefixes(self):
        ...
        self.accept_visitors(self.prefix_pemanis_visitors)
        if self.dictionary.contains(self.current_word):
            return
        self.accept_visitors(self.prefix_penanda_visitors)
        if self.dictionary.contains(self.current_word):
            return
        self.accept_visitors(self.prefix_persona_visitors)
        if self.dictionary.contains(self.current_word):
            return
